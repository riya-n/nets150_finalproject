...
//imports necessary libraries for Java swing
    ...
    public class GUI implements Runnable {
        ...
        public void run() { 
            ...
            JOptionPane.showMessageDialog(frame, "Will now be finding cities...Press OK to continue");
            System.out.println("Cities will be displayed soon");
            System.out.println("----------------");
            ...
            JOptionPane.showMessageDialog(frame, "Will now be finding Routes...Press OK to continue");
            System.out.println("----------------");
            System.out.println("Currently finding routes. May take a while.");
